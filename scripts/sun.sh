...
#python train2.py --dataset SUN --ga 30 --beta 0.3 --dis 5.0 --nSample 400 --gpu 0 --S_dim 2048 --NS_dim 2048 --lr 0.0003 \
#  --kl_warmup 0.001 --tc_warmup 0.0003 --vae_dec_drop 0.2 --dis_step 3 --ae_drop 0.4 --CS_dim 1024 --CNS_dim 1024 #
...
python train2.py --dataset SUN --ga 3 --beta 0.3 --dis 0.5 --nSample 400 --gpu 0 --S_dim 2048 --NS_dim 2048 --lr 0.0003 \
 --finetune True --CS_dim 1024 --CNS_dim 1024 #
#
