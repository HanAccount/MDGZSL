...
#python train2.py --dataset FLO  --ga 3 --beta 0.1 --dis 2.0 --nSample 1200 --gpu 0 --S_dim 2048 --NS_dim 2048 \
#  --lr 0.0001  --classifier_lr 0.003 --dis_step 3 --kl_warmup 0.001 --vae_dec_drop 0.4 --vae_enc_drop 0.4 \
#  --ae_drop 0.2 --CS_dim 1024 --CNS_dim 1024 #
...
python train2.py --dataset FLO  --ga 10 --beta 1.0 --dis 0.8 --nSample 1200 --gpu 0 --S_dim 2048 --NS_dim 2048 \
  --lr 0.0001  --classifier_lr 0.003 --finetune True --dis_step 1 --CS_dim 1024 --CNS_dim 1024 #
#
